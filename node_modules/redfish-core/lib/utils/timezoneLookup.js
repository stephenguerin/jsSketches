export function timezoneLookup(X, W) {
  ...
  if (((W = +W), !(-90 <= (X = +X) && X <= 90 && -180 <= W && W <= 180)))
    throw new RangeError("invalid coordinates");
  var S = -1,
    V = (48 * (180 + W)) / 360.00000000000006,
    U = (24 * (90 - X)) / 180.00000000000003,
    A = 0 | V,
    Z = 0 | U,
    J = 96 * Z + 2 * A;
  for (
    J = 56 * Y.charCodeAt(J) + Y.charCodeAt(J + 1) - 1995;
    J + T.length < 3136;
